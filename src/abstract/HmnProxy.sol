...
/// @title Proxy contract for human verification registries
/// @notice A base class for proxied classes.
/// @dev Any contract extending this must ensure to delegate to this contract's constructor.
abstract contract HmnProxy is ERC1967Proxy {
    ///////////////////////////////////////////////////////////////////////////////
    ///                             CONSTRUCTION                                ///
    ///////////////////////////////////////////////////////////////////////////////

    /// @notice Constructs a new instance of the proxy contract.
